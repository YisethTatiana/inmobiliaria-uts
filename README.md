...
- `docs/imagenes/diagramas_bd.pdf` — documento de entrega: portada, seccion del
  repositorio Git publico, como le fue en los 3 sprints, evidencia del tablero
  Padlet de seguimiento, MER + modelo relacional + casos de uso, y los scripts
  SQL (`DDL`, `DML`, `consultas` y `script_limpiar_demo`) pegados al final, listo
  para entregar.
